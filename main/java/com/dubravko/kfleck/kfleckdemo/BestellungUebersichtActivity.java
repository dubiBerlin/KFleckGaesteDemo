...
public class BestellungUebersichtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spc.setBestellungUebersichtList(Helper.convertObjectToString(gewaehlteZutatenListe));
        spc.updateBestellungUebersichtList(Helper.convertObjectToString(gewaehlteZutatenListe));
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        switch(item.getItemId()){
            case R.id.action_bar_next_btn:
                ...
                Intent intent = new Intent(BestellungUebersichtActivity.this, QRCodeActivity.class);
                intent.putExtra("Bestellung", spc.getBestellungUebersichtListAsString());
